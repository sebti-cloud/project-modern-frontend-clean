...
const About = () => {
    return (
        <div className="about-container">
            ...
            <section className="about-section">
                <h2>Our Team</h2>
                <p>At LAHRECH Company, we are proud of our diverse and talented team. Our team members come from various backgrounds and bring a wealth of experience and creativity to the table. Together, we work towards a common goal of delivering excellence in every aspect of our business.</p>
            </section>
            <section className="about-section">
                <h2>Why Choose Us?</h2>
                <ul>
