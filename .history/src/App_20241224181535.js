  ...
  const searchproduct = () => {
    if (!search) {
      ...
      const searchfilter = Homeproduct.filter((x) => {
        const nameMatch = typeof x.name === 'string' && x.name.toLowerCase().includes(search.toLowerCase());
        const catMatch = typeof x.cat === 'string' && x.cat.toLowerCase().includes(search.toLowerCase());
