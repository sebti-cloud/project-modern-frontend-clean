...
import AuthTest from './comp/AuthTest'; // Assurez-vous que l'importation est correcte
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/add-admin" element={isAuthenticated ? <AddAdmin /> : <Navigate to="/login" />} />
        ...
        <Route path="/likedProducts" element={isAuthenticated ? <LikedProducts /> : <Navigate to="/login" />} />
        <Route path="/categories" element={isAuthenticated ? <Categories /> : <Navigate to="/login" />} />
        <Route path="/contacts" element={isAuthenticated ? <AdminContacts /> : <Navigate to="/login" />} />
        <Route path="/admins" element={isAuthenticated ? <AdminList /> : <Navigate to="/login" />} />
        <Route path="/" element={<AuthTest />} /> {/* Utiliser AuthTest */}
      </Routes>
      <Footer />
    </Router>
  );
