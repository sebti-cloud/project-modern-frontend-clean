  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/add-admin" element={<AdminRoute element={<AddAdmin />} />} />
        <Route path="/products" element={<AdminRoute element={<Products />} />} />
        <Route path="/orders" element={<AdminRoute element={<Orders />} />} />
        <Route path="/liked-products" element={<AdminRoute element={<LikedProducts />} />} />
        <Route path="/categories" element={<AdminRoute element={<Categories />} />} />
        <Route path="/contacts" element={<AdminRoute element={<AdminContacts />} />} />
        <Route path="/admins" element={<AdminRoute element={<AdminList />} allowedRoles={['Admin principale', 'Moderateur']} />} />
      </Routes>
