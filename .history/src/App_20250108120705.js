...
import LikedProducts from './comp/LikedProducts';
import Categories from './comp/Categories';
import AdminContacts from './comp/AdminContacts'; // Assurez-vous que le chemin est correct
import AdminList from './comp/AdminList';
import AdminSettings from './comp/AdminSettings'; // Assurez-vous que le chemin est correct
import Cart from './comp/cart'; // Importez Cart
import Register from './comp/Register'; // Importez Register
import Login from './comp/Login'; // Importez Login
import UserProfile from './comp/UserProfile'; // Importez UserProfile
import UserOrders from './comp/UserOrders'; // Importez UserOrders
import UserLikedProducts from './comp/UserLikedProducts'; // Importez UserLikedProducts
import UserActivity from './comp/UserActivity'; // Importez UserActivity
import Cookies from 'js-cookie';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/likedProducts" element={<LikedProducts />} />
        <Route path="/categories" element={<Categories />} />
        <Route path="/contacts" element={<AdminContacts />} /> {/* Ajoutez la route pour Contact */}
        <Route path="/admins" element={<AdminList />} />
        <Route path="/admin-settings" element={<AdminSettings />} /> {/* Ajoutez la route pour AdminSettings */}
        <Route path="/cart" element={<Cart cart={cart} setCart={setCart} />} /> {/* Ajoutez la route pour Cart */}
        <Route path="/register" element={<Register />} /> {/* Ajoutez la route pour Register */}
        <Route path="/login" element={<Login setIsAuthenticated={setIsAuthenticated} />} /> {/* Ajoutez la route pour Login */}
        <Route path="/profile" element={isAuthenticated ? <UserProfile /> : <Navigate to="/login" />} /> {/* Ajoutez la route pour UserProfile */}
        <Route path="/user-orders" element={isAuthenticated ? <UserOrders /> : <Navigate to="/login" />} /> {/* Ajoutez la route pour UserOrders */}
        <Route path="/user-liked-products" element={isAuthenticated ? <UserLikedProducts /> : <Navigate to="/login" />} /> {/* Ajoutez la route pour UserLikedProducts */}
        <Route path="/user-activity" element={isAuthenticated ? <UserActivity /> : <Navigate to="/login" />} /> {/* Ajoutez la route pour UserActivity */}
        <Route path="/*" element={
          <Rout setCart={setCart} cart={cart} shop={shop} Filter={Filter} allcatfilter={allcatfilter} addtocart={addtocart} fetchProducts={fetchProducts} searchproduct={searchproduct} searchResults={searchResults} />
        } />
      </Routes>
