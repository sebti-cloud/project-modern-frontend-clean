...
import LikedProducts from './comp/LikedProducts';
import Categories from './comp/Categories';
import AdminContacts from './comp/AdminContacts'; // Assurez-vous que Contact est importé et utilisé ici
import AdminList from './comp/AdminList';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/likedProducts" element={<LikedProducts />} />
        <Route path="/categories" element={<Categories />} />
        <Route path="/contacts" element={<AdminContacts />} /> {/* Ajoutez la route pour AdminContacts */}
        <Route path="/admins" element={<AdminList />} />
...
import LikedProducts from './comp/LikedProducts';
import Categories from './comp/Categories';
import AdminContacts from './comp/AdminContacts'; // Importez AdminContacts
import AdminList from './comp/AdminList';
import AdminSettings from './comp/AdminSettings';
import Cart from './comp/cart';
import Register from './comp/Register';
