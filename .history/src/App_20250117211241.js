  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/payment/:orderId" element={<Payment />} /> {/* Modifié pour inclure l'ID de commande */}
        ...
        <Route path="/user-activities/:userId" element={isAuthenticated ? <UserActivity /> : <Navigate to="/login" />} />
        <Route path="/*" element={
...
import AdminList from './comp/AdminList';
import AdminSettings from './comp/AdminSettings';
import AdminUsers from './comp/AdminUsers'; // Ajouter cette ligne
import Cart from './comp/cart';
import Register from './comp/Register';
import Login from './comp/Login';
import UserProfile from './comp/UserProfile';
