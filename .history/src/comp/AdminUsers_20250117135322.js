          ...
          <tbody>
            {users.map(user => (
              <tr key={user.id}>
                ...
                <td>
                  <img
                    src={user.photo ? `http://localhost:3001${user.photo}` : 'http://localhost:3001/uploads/default-user.png'}
                    alt={user.name}
                    className="user-photo"
                    onClick={() => openModal(user.photo ? `http://localhost:3001${user.photo}` : 'http://localhost:3001/uploads/default-user.png')}
