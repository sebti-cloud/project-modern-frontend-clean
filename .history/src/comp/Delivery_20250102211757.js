    ...
    return (
        <div className="delivery">
            ...
            <div className="contact">
                <h3>Need Help?</h3>
                <p>If you have any questions about delivery, please contact our support team at <a href="mailto:support@example.com">support@example.com</a> or call us at (123) 456-7890.</p>
            </div>
        </div>
    );
};
