...
// Clé publique Stripe (Remplacez par la vôtre)
...
const Payment = ({ amount }) => {
  ...
  const handlePayment = async (e) => {
    ...
    if (error) {
      ...
      alert('Erreur lors de la création du token Stripe');
      return;
    }
    ...
    try {
      ...
      alert('Erreur lors du traitement du paiement : ' + error.response.data.error.message);
    }
  };
