...
const Payment = () => {
  ...
  useEffect(() => {
    const fetchTotal = async () => {
      try {
        ...
        console.log('Montant total récupéré:', data.total); // Vérifiez la valeur récupérée
        setTotal(data.total);
      } catch (error) {
  ...
  useEffect(() => {
    console.log('Total:', total); // Vérifiez que le total est correctement défini
    if (total !== null) {
      ...
      script.onload = () => {
        ...
        console.log('PayPal script loaded'); // Vérifiez que le script PayPal est chargé
      };
      script.onerror = () => {
  ...
  useEffect(() => {
    console.log('PayPal Loaded:', paypalLoaded); // Vérifiez que PayPal est bien chargé
  ...
  if (total === null) {
    console.log('Loading...'); // Vérifiez que le composant de chargement s'affiche
