                ...
                <div className="payment-body">
                  <div className="payment-plan">
                    ...
                    <div className="payment-plan-info">
                      ...
                      <div className="payment-plan-info-price">${usdTotal} par mois</div> {/* Utiliser le montant en USD */}
                    </div>
                  ...
                  <div className="payment-summary">
                    <div className="payment-summary-item">
                      ...
                      <div className="payment-summary-price">$1</div> {/* Exemple de frais en USD */}
                    </div>
                    <div className="payment-summary-item">
                      <div className="payment-summary-name">Réduction 20%</div>
                      <div className="payment-summary-price">-$2</div> {/* Exemple de réduction en USD */}
                    </div>
                    <div className="payment-summary-divider"></div>
                    <div className="payment-summary-item payment-summary-total">
                      <div className="payment-summary-name">Total</div>
                      <div className="payment-summary-price">${usdTotal}</div> {/* Utiliser le montant en USD */}
                    </div>
                  </div>
                </div>
              </div>
