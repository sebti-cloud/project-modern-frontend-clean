...
const Payment = () => {
  ...
  console.log('orderId:', orderId); // Ajoutez un log pour vérifier la valeur de orderId
  ...
  useEffect(() => {
    const fetchOrderDetails = async () => {
      ...
      try {
        ...
        setTrackingNumber(data.tracking_number || ''); // Utiliser le nom exact de la propriété
        setUserName(data.user_name || ''); // Utiliser le nom exact de la propriété

        if (!data.user_email) {
          console.error("Email non défini.");
        }
        if (!data.tracking_number) { // Utiliser le nom exact de la propriété
                ...
                <div className="payment-body">
                  ...
                  <div className="payment-summary">
                    ...
                    <div className="payment-summary-item">
                      ...
                      <div className="payment-summary-price">-$2</div>                    </div>
