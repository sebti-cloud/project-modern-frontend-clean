      ...
      window.paypal.Buttons({
        ...
        onApprove: function(data, actions) {
          return actions.order.capture().then(async function(details) {
            ...
            console.log('Order ID utilisé pour mise à jour:', orderId);
            ...
            try {
              ...
              // Logs supplémentaires avant d'appeler updatePaymentStatus
              console.log('Appel de updatePaymentStatus avec Order ID:', orderId, 'et Transaction ID:', details.id);
              // Mettre à jour le statut du paiement et le Transaction ID dans la table pending_orders
              await updatePaymentStatus(orderId, details.id);
              console.log('Mise à jour du statut de paiement et du Transaction ID réussie.');

              // Logs supplémentaires avant d'appeler handleOnlineCheckout
              console.log('Appel de handleOnlineCheckout avec Order ID:', orderId, 'et Transaction ID:', details.id);
          ...
          <div className="payment-wrapper">
            <div className="payment-left">
              <div className="payment-header">
                ...
                <div className="payment-header-title">Résumé de la commande</div              ></div>
