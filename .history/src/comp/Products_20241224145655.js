    ...
    return (
        <div className="products">
            ...
            <form onSubmit={editProduct ? handleUpdateProduct : handleAddProduct}>
                ...
                <textarea type="text" name="details" placeholder="Details" value={editProduct ? editProduct.details : newProduct.details} onChange={handleChange} required></textarea> {/* Champ pour les détails du produit */}
