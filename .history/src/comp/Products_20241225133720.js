    ...
    return (
        <div className="products">
            ...
            <form onSubmit={editProduct ? handleUpdateProduct : handleAddProduct}>
                ...
                <textarea type="text" className="details" placeholder="Details" value={editProduct ? editProduct.details : newProduct.details} onChange={handleChange} required></textarea> {/* Champ pour les détails du produit */}
            ...
            <table className="products-table">
                <thead>
                    <tr>
                        ...
                        <th>Type</th>
                        <th>Price</th>
                        <th>Details</th> {/* Ajout de la colonne Details */}
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    {products.map(product => (
                        <tr key={product.id}>
                            ...
                            <td>{product.details}</td> {/* Affichage des détails du produit */}
                            <td>
                                ...
                                <select value={selectedType} onChange={(e) => handleUpdateType(product.id, e.target.value)} className="type-select">
