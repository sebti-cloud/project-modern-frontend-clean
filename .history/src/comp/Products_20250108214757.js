...
const Products = () => {
  ...
  const handleUpdateType = async (productId, newType) => {
    try {
        ...
        console.log('Updated types:', types); // Ajoutez cette ligne pour vérifier les types
    ...
    <div className="admin-dashboard">
      ...
      <div className="products">
        ...
        <form onSubmit={editProduct ? handleUpdateProduct : handleAddProduct}>
          ...
          <select name="types" value={editProduct ? (editProduct.types.length ? editProduct.types : '') : (newProduct.types.length ? newProduct.types : '')} onChange={handleChange} multiple required >
