...
const Cart = ({ cart, setCart }) => {
    ...
    const handleCheckout = async (e) => {
        ...
        if (response.ok) {
            ...
            setTrackingNumber(data.trackingNumber); // Mettre à jour le numéro de suivi
            setCart([]);
            setCheckout(false);
...
const Cart = ({ cart, setCart }) => {
    const [checkout, setCheckout] = useState(false);
    const [userInfo, setUserInfo] = useState({ name: '', surname: '', phone: '', email: '', address: '' }); // Ajout de l'adresse
    const [trackingNumber, setTrackingNumber] = useState('');
    const [modalIsOpen, setModalIsOpen] = useState(false);
                ...
                <div className='checkout'>
                    ...
                    <form onSubmit={handleCheckout}>
                        <div className='container'>
                            ...
                            <input type='text' name='surname' placeholder='Surname' value={userInfo.surname} onChange={handleChange} required />
                            <input type='text' name='phone' placeholder='Phone' value={userInfo.phone} onChange={handleChange} required />
                            <input type='email' name='email' placeholder='Email' value={userInfo.email} onChange={handleChange} required /> {/* Ajout du champ email */}
                            <input type='text' name='address' placeholder='Adresse' value={userInfo.address} onChange={handleChange} required /> {/* Ajout du champ adresse */}
                            <button type='submit'>Submit</button>
                        </div>
                    </form>
                </div>
