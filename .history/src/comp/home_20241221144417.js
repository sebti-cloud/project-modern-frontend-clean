...
const Home = ({ addtocart }) => {
    ...
    const [showLikedMessage, setShowLikedMessage] = useState(false);  // État pour afficher le message
                ...
                <div id="new-product" class="product_type">
                    <div class="container">
                        ...
                        <div id="contact-address" class="section">
                            -- Contenu de la section Contact Address --
                        </div>
                        <div id="contact-email" class="section">
                            -- Contenu de la section Contact Email --
                        </div>
                        <div id="contact-phone" class="section">
                            -- Contenu de la section Contact Phone --
                        </div>
                    </div>
                </div>
            </div>
