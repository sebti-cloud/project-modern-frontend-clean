            ...
            <div className="home">
                    ...
                    <div className="container">
                        <div className='left_box'>
                            <div className="header">
                                ...
                                <div className="cate">
                                    <h3 onClick={() => filtertype('new')}>New</h3>
                                    <h3 onClick={() => filtertype('featured')}>Featured</h3>
                ...
                <div id="new-product" class="product_type">
                    <div class="container">
                        ...
                        <div id="contact-address" class="section"></div>
                        <div id="contact-email" class="section"></div>
                        <div id="contact-phone" class="section"></div>
                    </div>
                </div>
            </div>
        </>
