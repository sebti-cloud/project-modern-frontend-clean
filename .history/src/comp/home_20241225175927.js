...
const Home = ({ addtocart }) => {
    ...
    const fetchProducts = async () => {
        try {
          ...
          const newProducts = data.filter((x) => x.types.includes('new'));
          const featuredProducts = data.filter((x) => x.types.includes('featured'));
          const topProducts = data.filter((x) => x.types.includes('top'));
                ...
                <div className='product_detail'>
                    ...
                    <div className='container'>
                        ...
                        <div className='info'>
                            ...
                            <button onClick={() => addtocart(detail)}>Ajouter au</button>
                        </div>
                    </div>
                </div>
            ) : null}
